...
export async function GET(
  ...
  try {
    ...
    console.error('Error in GET /api/proxy/employees/[id]:', error);
...
export async function PUT(
  ...
  try {
    ...
    console.error('Error in PUT /api/proxy/employees/[id]:', error);
    return NextResponse.json(
...
export async function DELETE(
  ...
  try {
    ...
    console.error('Error in DELETE /api/proxy/employees/[id]:', error);
    return NextResponse.json(
